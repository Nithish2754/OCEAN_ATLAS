...
const problems = [
  {
    icon: <Eye size={22} className="text-[#00d4ff]" />,
  ...
  {
    icon: <DollarSign size={22} className="text-[#c9913a]" />,
  ...
  {
    icon: <AlertTriangle size={22} className="text-[#00d4ff]" />,
...
export default function About() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(180deg, #0a1a2f 0%, #061428 100%)' }}
    >
      {/* Background glow */}
      <div
        className="absolute top-0 right-0 w-96 h-96 rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(0,212,255,0.04) 0%, transparent 70%)', transform: 'translate(30%, -30%)' }}
      />
      ...
      <div className="container-app">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-[#7ab8d4] leading-relaxed" style={{ fontSize: '0.975rem', marginBottom: '0.8rem' }}>
            ...
            <p className="text-[#7ab8d4] leading-relaxed" style={{ fontSize: '0.975rem', margin: 0 }}>
              The <span className="text-[#00d4ff] font-medium">OceanAtlas system</span> addresses
          ...
          <div className="card-stack">
            {problems.map((p) => (
              ...
              >
                <div
                  className="rounded-xl bg-[#0a1a2f] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-200"
                ...
                <div>
                  ...
                  <p className="text-[#6a9ab5] leading-relaxed" style={{ fontSize: '0.85rem' }}>
                    {p.desc}
                  </p>
                </div>
              </div>
